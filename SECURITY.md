...
**Agent Governance** is part of the [Agent Governance Ecosystem](https://github.com/imran-siddique) — a suite of open-source projects for building, orchestrating, and governing autonomous AI agents in enterprise environments.
...
Only the latest release of Agent Governance receives security updates. Users are strongly encouraged to stay up to date.

## Reporting a Vulnerability

If you discover a security vulnerability in Agent Governance, please report it responsibly.
...
- Source code of Agent Governance
- Third-party dependencies used by Agent Governance
...
Agent Governance is part of the broader **Agent Governance Ecosystem**, which provides a unified framework for secure, observable, and compliant AI agent operations. Security policies are coordinated across all ecosystem projects to ensure consistent protection.

For ecosystem-wide security concerns, please contact [security@imransiddique.com](mailto:security@imransiddique.com).

---

Thank you for helping keep Agent Governance and the Agent Governance Ecosystem safe for everyone.
